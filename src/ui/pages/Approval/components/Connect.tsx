...
export default function Connect({ params: { session } }: Props) {
      ...
      <Layout>
        ...
        <Content>
          <Column>
            ...
            <Text text="Your access to this page has been restricted by Ubox Wallet as it might be unsafe." mt="md" />
          </Column>
        </Content>

        <Footer>
          <Row full>
            <Button text="Reject (blocked by Ubox Wallet)" preset="danger" onClick={handleCancel} full />
          </Row>
        </Footer>
      </Layout>
    );
  ...
  return (
    <Layout>
      ...
      <Content>
        <Column>
          <Text text="Connect with Ubox Wallet" preset="title-bold" textCenter mt="lg" />
